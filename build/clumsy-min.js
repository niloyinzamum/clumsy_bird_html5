var game = {
    ...
    onload: function () {
        return me.video.init(900, 600, { wrapper: "screen", scale: "auto", scaleMethod: "fit" })
            ? (me.audio.init("mp3,ogg"), void me.loader.preload(game.resources, this.loaded.bind(this)))
    ...
    update: function (a) {
        ...
        if ((this.renderable.currentTransform.identity(), me.input.isKeyPressed("fly"))) {
            ...
            this.angleTween.stop(),
                ...
                this.flyTween.start(),
                this.angleTween.to({ currentAngle: b.maxAngleRotation }, 50).onComplete(function (a) {
            ...
            (this.gravityForce += 0.2),
                ...
                this.currentAngle >= this.maxAngleRotationDown && (this.renderable.currentTransform.identity(), (this.currentAngle = this.maxAngleRotationDown));
    ...
    (game.PipeEntity = me.Entity.extend({
        ...
        update: function (a) {
            return game.data.start
                ? (this.pos.add(this.body.vel), this.pos.x < -this.image.width && me.game.world.removeChild(this), me.Rect.prototype.updateBounds.apply(this), this._super(me.Entity, "update", [a]), !0)
...
(game.TitleScreen = me.ScreenObject.extend({
    ...
    onResetEvent: function () {
        me.audio.stop("theme"),
            ...
            (this.logo = new me.Sprite(me.game.viewport.width / 2, me.game.viewport.height / 2 - 20, { image: "logo" })),
    ...
    (game.PlayScreen = me.ScreenObject.extend({
        ...
        onResetEvent: function () {
            me.game.reset(),
                ...
                (this.getReady = new me.Sprite(me.game.viewport.width / 2, me.game.viewport.height / 2, { image: "getready" })),
    ...
    (game.GameOverScreen = me.ScreenObject.extend({
        ...
        onResetEvent: function () {
            (this.savedData = { score: game.data.score, steps: game.data.steps }),
                ...
                me.game.world.addChild(new me.Sprite(me.game.viewport.width / 2, me.game.viewport.height / 2 - 100, { image: "gameover" }), 12);
            var a = new me.Sprite(me.game.viewport.width / 2, me.game.viewport.height / 2, { image: "gameoverbg" });
            if (
